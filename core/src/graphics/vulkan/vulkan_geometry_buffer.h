#ifndef CORE_SRC_GRAPHICS_VULKAN_VULKAN_GEOMETRY_BUFFER_H
#define CORE_SRC_GRAPHICS_VULKAN_VULKAN_GEOMETRY_BUFFER_H
...
#endif //CORE_SRC_GRAPHICS_VULKAN_VULKAN_GEOMETRY_BUFFER_H
