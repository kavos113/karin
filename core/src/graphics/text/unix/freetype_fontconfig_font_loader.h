#ifndef GRAPHICS_TEXT_UNIX_FREETYPE_FONTCONFIG_FONT_LOADER_H
#define GRAPHICS_TEXT_UNIX_FREETYPE_FONTCONFIG_FONT_LOADER_H
...
#endif //GRAPHICS_TEXT_UNIX_FREETYPE_FONTCONFIG_FONT_LOADER_H
